...
//			- (((mezawla1.at<float>(0, 0))) * firstImageInfinityMat)
//			- (((mezawla2.at<float>(0, 0))) * secondImageInfinityMat);
...
//	Mat point = (Mat_<float>(3, 1) << 260, 209, 1);
//	Mat point2 = (Mat_<float>(3, 1) << 204, 148, 1);
////	Mat fundPrint = fundametalMatrix(4.3, 640, 480, 2.7446, 3.5311, 320, 240,
////			-35.16, -46.77, -155.57, 25.03, -55.56, -47.08, -1535.21, 1720.84,
////			1693.22, -1694.56, -142.25, 1585.19);
////	for (int i = 0; i < fundPrint.rows; i++) {
////		for (int j = 0; j < fundPrint.cols; j++) {
////			printf("%f", fundPrint.at<float>(i, j));
////			printf(", ");
////		}
////		printf("\n");
////	}
...
//			-46.77, -155.57, point);
//	Mat min2 = mInfinityMat(4.3, 640, 480, 2.7446, 3.5311, 320, 240, 25.03,
//			-55.56, -47.08, point2);
