...
public abstract class BaseActivity extends Activity {
	...
	private static final String PREF_USER_ISFEMALE = "PREF_USER_ISFEMALE";
	...
	*/
	...
	protected User getCurrentUser() {
		if (currentUser == null) {
			...
			if (sharedPreferences.contains(PREF_USER_TOKEN)) {
				...
				currentUser.setFirstName(sharedPreferences.getString(PREF_USER_FIRSTNAME, null));
				currentUser.setLastName(sharedPreferences.getString(PREF_USER_LASTNAME, null));
	...
	protected void setCurrentUser(User user) {
		...
		if ((currentUser = user) != null) {
			...
			p.putString(PREF_USER_FIRSTNAME, currentUser.getFirstName());
			p.putString(PREF_USER_LASTNAME, currentUser.getLastName());
